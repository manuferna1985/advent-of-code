...
public class D11_exercise_Part1 {

    public static void main(String[] args) throws Exception {

        // Initialize
        List<String> allLines = Files.readAllLines(
                Paths.get(D11_exercise_Part1.class.getResource("2021/D11_full.txt").toURI()), Charset.defaultCharset());
        ...
        for (int step=0; step<100; step++) {
            ...
            System.out.println("mini step 1");
            ...
            System.out.println("mini step 2");
            boolean newFlashes;
            do{
                newFlashes = false;
            ...
            System.out.println("mini step 3");
            for (int i = 0; i < matrix.length; i++) {
                for (int j = 0; j < matrix[i].length; j++) {
                    if (matrix[i][j] > 9) {
                        matrix[i][j] = 0;
